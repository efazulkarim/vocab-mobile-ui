...
const BUNDLE_ID = 'com.wordrizz'; // ios bundle id
const PACKAGE = 'com.wordrizz'; // android package name
const NAME = 'WordRizz'; // app name
const EXPO_ACCOUNT_OWNER = 'bitsic'; // expo account owner
const EAS_PROJECT_ID = '1e53482c-9a4f-4742-b790-9d29083676e7'; // eas project id
const SCHEME = 'wordrizz'; // app scheme
