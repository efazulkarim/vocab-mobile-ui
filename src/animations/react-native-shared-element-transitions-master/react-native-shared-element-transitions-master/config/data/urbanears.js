export default [
  {
    type: 'Humlan P',
    imageUri: require('../../assets/urbanears/urbanears_blue.png'),
  ...
  {
    type: 'Pampas',
    imageUri: require('../../assets/urbanears/urbanears_pink.png'),
  ...
  {
    type: 'Humlan P',
    imageUri: require('../../assets/urbanears/urbanears_grey.png'),
  ...
  {
    type: 'Humlan B',
    imageUri: require('../../assets/urbanears/urbanears_mint.png'),
    heading: 'From Sweden',
    description:
