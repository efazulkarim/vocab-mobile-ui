...
> = {
  ...
  secondary: {
    container:
      'mb-4 w-full items-center rounded-full border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-6 py-4',
    text: 'text-lg font-medium text-brand-700 dark:text-brand-400',
    opacity: 0.85,
  },
  link: {
    container: 'items-end py-2 pr-2',
    text: 'text-base font-medium text-brand-700 dark:text-brand-400',
    opacity: 0.7,
  },
};
    ...
    <SafeAreaView className="flex-1 bg-white dark:bg-black">
      ...
      <View className="flex-1 items-center justify-center px-6">
        ...
        <View className="mb-2 items-center">
          <Text className="text-5xl font-bold tracking-tight text-brand-700 dark:text-brand-400">
            memli
          </Text>
          <View className="mt-1 h-1 w-40 rounded-full bg-brand-700 dark:bg-brand-400" />
        </View>
